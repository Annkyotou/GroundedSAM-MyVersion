...
def main():
    ...
    for iid in used_iids:
        ...
        instance_confidence = matching_rows['Instance Confidence'].values[0] if not matching_rows.empty else 0.0
    ...
    header = ["Scene Type", "Confidence", "Instance ID", "Label", "Instance Confidence", "Area", "Material", "Confidence"] + corner_labels
